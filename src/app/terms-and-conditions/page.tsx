...
export default function Home() {
  return (
    <main
      className={`flex bg-white min-h-screen flex-col items-center text-[#2E2924] justify-between ${sourceSans.className}`}
    >
      <Header />
      <div className="max-w-[1140px] w-full px-[20px] py-[40px] text-[16px] leading-[24px] text-[#2E2924]">
        ...
        <p className="pb-[20px]">
          ...
          use of www.WhyDoesGames.com’s Website, located at
          www.WhyDoesGames.com.
        </p>
        <p className="pb-[20px]">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Why Does Games if you do not agree
        ...
        <h2>
          <strong>Cookies</strong></h2>
        <p className="pb-[20px]">
          We employ the use of cookies. By accessing Why Does Games, you agreed
          to use cookies in agreement with the www.WhyDoesGames.com’s Privacy
          Policy.
        </p>
        <p className="pb-[20px]">
        ...
        <p className="pb-[20px]">
          Unless otherwise stated, www.WhyDoesGames.com and/or its licensors own
          the intellectual property rights for all material on Why Does Games.
          All intellectual property rights are reserved. You may access this
          from Why Does Games for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>
        <p className="pb-[20px]">You must not:</p>
        <ul>
          <li>Republish material from Why Does Games</li>
          <li>Sell, rent or sub-license material from Why Does Games</li>
          <li>Reproduce, duplicate or copy material from Why Does Games</li>
          <li>Redistribute content from Why Does Games</li>
        </ul>
        <p className="pb-[20px]">
          This Agreement shall begin on the date hereof. Our Terms and
          Conditions were created with the help of the<span>&nbsp;</span>
        ...
        <p className="pb-[20px]">
          ...
          www.WhyDoesGames.com does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of www.WhyDoesGames.com,its agents and/or
          ...
          laws, www.WhyDoesGames.com shall not be liable for the Comments or for
        ...
        <p className="pb-[20px]">
          www.WhyDoesGames.com reserves the right to monitor all Comments and to
          remove any Comments which can be considered inappropriate, offensive
          or causes breach of these Terms and Conditions.
        </p>
        <p className="pb-[20px]">You warrant and represent that:</p>
        <ul>
          <li>
        ...
        <p className="pb-[20px]">
          ...
          the hyperlink compensates the absence of www.WhyDoesGames.com; and (d)
        ...
        <p className="pb-[20px]">
          ...
          sending an e-mail to www.WhyDoesGames.com. Please include your name,
        ...
        <p className="pb-[20px]">
          No use of www.WhyDoesGames.com’s logo or other artwork will be allowed
        ...
        <p className="pb-[20px]">Please read Privacy Policy</p>
        <h3>
